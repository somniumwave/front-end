            ...
            <footer className="text-center text-gray-600">
                ...
                <div className="justify-center items-center lg:justify-between p-4 border-b border-white border-opacity-10">
                    ...
                    <div className="flex justify-center">
                        ...
                        <a href="https://www.discord.gg/somniumwave" className="mr-6 text-gray-600 incbtn ease-linear transition-all duration-300">
                        ...
                        <a href="https://www.twitter.com/somniumwave" className="mr-6 text-gray-600 incbtn ease-linear transition-all duration-300">
                        ...
                        <a href="https://github.com/somniumwave" className="text-gray-600 mr-6 incbtn ease-linear transition-all duration-300">
                        ...
                        <a href="https://instagram.com/somniumwave" className=" text-gray-600 incbtn ease-linear transition-all duration-300">
